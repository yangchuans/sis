...
public class RealTimeDBDaoTest {
    ...
    public static void main(String[] args) {
       ...
       // System.out.println(dao.SC_InitialEnv("127.0.0.1", (short) 5656, "sa", "sa"));
        ...
        /* 获取单点某一时间的历史数据 */
//        PointData PointData1 = dao.SC_GetHistPoint("DCS1.GEMW", 1487862388L, (short) 0);
...
//        }
        ...
        ArrayList<PointData>  PointDatas = dao.SC_GetHistRawUTC("DCS2.10BBA07GS000GH3", 1487862388L, (short)0, 1487862398L, (short)0);
        if (PointDatas == null) {
